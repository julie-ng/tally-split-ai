...
describe('TASK_PERMISSIONS', () => {
  it('should have entries for all known tasks', () => {
    const expectedTasks = ['receipt-workflow', 'analyze-ocr', 'analyze-annotations', 'create-expense', 'adjust-expense', 'normalize-receipt']
...
describe('getTaskChildren', () => {
  it('should return children for a known orchestrator', () => {
    ...
    expect(children).toEqual(['analyze-ocr', 'analyze-annotations', 'create-expense', 'adjust-expense', 'normalize-receipt'])
  })
