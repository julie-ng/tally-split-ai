 ...
 * ?preview / open-state / tab / esc plumbing, supplies the expense+receipt warm,
...
export function useExpensePreview () {
  ...
  // Generic ?preview / open / tab / esc / warm plumbing. The expense-specific
  // warm: fetch the expense, then warm its linked RECEIPT into the receipts
  ...
  // not during the brief warm window (usePreviewPanel's warm handles cold-load).
