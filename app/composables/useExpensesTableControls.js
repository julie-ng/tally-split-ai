 ...
 * and the derived `filteredExpenses` + `sorting` they produce.
 *
 * Owned by the page (or a page-level component), NOT the expenses store —
 * this is ephemeral UI state, not domain data.
 *
 * @param {import('vue').Ref<Array>} expensesRef - reactive array of expenses
 * @returns {Object} state, derived data, and dropdown menu items
 */
export function useExpensesTableControls (expensesRef) {
