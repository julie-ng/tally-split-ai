  ...
  <div class="grid grid-cols-3 gap-x-20">
    <div>
      <div class="grid grid-cols-2 gap-0">
        <div class="py-1 text-slate-500 text-sm">Analyzed At</div>
        <div class="py-1.5 text-sm text-right">{{ timestampUtils.toShortDate(props.analyzedAt) }}</div>
        <div class="py-1.5 text-slate-500 text-sm">Analysis Status</div>
    ...
    <div>
      ...
      <p class="text-sm text-slate-500 mb-1">Merchant</p>
