...
<div>
  ...
  <!-- Tabs -->
  <UTabs :items="tabItems" size="xl" variant="link" class="w-full" v-model="activeTab" :ui="{ indicator: 'border-b-3 border-primary', trigger: 'cursor-pointer' }">
    ...
    <template #rawJson="{ item }">
       <div class="bg-slate-800 p-4">
        <vue-json-pretty :data="props.upload"
          :indent="2"
          :deep="4"
          :showIcon="true"
          :showLength="true"
