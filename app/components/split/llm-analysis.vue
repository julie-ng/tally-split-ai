...
splitsStore.fetchSplitHistory(props.splitId)

const llmChange = computed(() => splitsStore.getLlmChange(props.splitId))
const historyLoaded = computed(() => !!splitsStore.history[props.splitId])
</script>
