  ...
  <div id="security-token-design">
    <div v-if="content" class="w-full">
      ...
      <div class="text-center">
        <UCard class="shadow-md/5 bg-linear-to-b from-neutral-50 to-neutral-100 ring-1 ring-neutral-200 dark:from-neutral-800 dark:to-neutral-900 dark:ring-neutral-700">
            ...
            <template v-for="(c, i) in content.components" :key="`hmac-input-${i}`">
              <div>
                <UBadge
                  ...
                  variant="soft"
                  size="3"
                  class="block px-2 py-1 rounded font-mono text-muted"
                >
                  {{ c.example }}
                </UBadge>
        ...
        <UCard class="shadow-md/5 max-w-sm mx-auto bg-linear-to-b from-neutral-50 to-neutral-100 ring-1 ring-neutral-200 dark:from-neutral-800 dark:to-neutral-900 dark:ring-neutral-700">
        ...
        <UCard class="shadow-md/5 max-w-sm mx-auto bg-linear-to-b from-neutral-50 to-neutral-100 ring-1 ring-primary/30 dark:from-neutral-800 dark:to-neutral-900">
          <div class="flex items-center justify-center gap-1 font-semibold text-primary">
