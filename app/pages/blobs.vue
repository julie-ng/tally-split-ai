...
<template>
  <UContainer>
    <div class="my-5">
      <h1 class="font-bold text-3xl">Blobs</h1>
      ...
      <div v-else class="mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <article v-for="blob in data.blobs" :key="blob.filename"
            ...
            <div class="mb-4 bg-slate-100 rounded overflow-hidden">
              <img :src="blob.sasUrl" :alt="blob.filename" class="w-full h-48 object-cover" loading="lazy" />
            </div>
            ...
            <div class="flex gap-2">
              <a :href="blob.sasUrl" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 underline">
                View Full Size
              </a>
            </div>
          </article>
